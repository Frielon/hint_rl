#!/usr/bin/env bash
# =============================================================================
# Ray Cluster Auto-Launch & Job Submission -- FULLY-ASYNC Qwen3-4B GRPO edition
# =============================================================================
...
#   * TRAIN_SCRIPT default -> run_grpo_qwen3_4b_instruct_2507_npu_async.sh
#     (1 trainer + 2 rollout nodes, verl fully_async_policy).
#   * NNODES default 3 (1 trainer + 2 rollout), still overridden by the
...
#                         run_grpo_qwen3_4b_instruct_2507_npu_async.sh).
# =============================================================================
...
# script's dir.
TRAIN_SCRIPT=${TRAIN_SCRIPT:-"${SCRIPT_DIR}/run_grpo_qwen3_4b_instruct_2507_npu_async.sh"}
