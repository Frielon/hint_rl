...
# (default: run_grpo_olmo3_7b_instruct_npu.sh), or overridden via the TRAIN_SCRIPT env
...
# script's dir.
TRAIN_SCRIPT=${TRAIN_SCRIPT:-"${SCRIPT_DIR}/run_grpo_olmo3_7b_instruct_npu.sh"}
