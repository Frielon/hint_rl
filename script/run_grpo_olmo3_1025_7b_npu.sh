...
# ---------------------------------------------------------------------------
# Plain GRPO variant for Olmo-3-1025-7B. This is a copy of
# run_grpo_qwen3_8b_npu.sh with the model swapped to Olmo-3-1025-7B
# (${BASE_HOME}/model/Olmo-3-1025-7B); everything else (algorithm, lr
...
#     model/Olmo-3-1025-7B/         -> MODEL_PATH
#     project/
#       verl/                           -> VERL_HOME
...
project_name='GRPO-Olmo-3-1025-7B'
exp_name="GRPO-Olmo-3-1025-7B-dapo-3139-$(TZ='America/Los_Angeles' date +%Y%m%d-%H%M%S)"
...
# Paths
MODEL_PATH=${MODEL_PATH:-"${BASE_HOME}/model/Olmo-3-1025-7B"}
...
TEST_FILE4=${TEST_FILE4:-"${HINT_RL_HOME}/dataset/acereason_math_sample_1024.parquet"}
