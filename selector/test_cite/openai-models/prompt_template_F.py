# =============================================================================
# openai-models LOCAL editable copy of the SINGLE-ROUND prompt.
# Editing THIS file changes the prompt used by run_openai_selection.py /
# run_openai_eval.sh (with the default --prompt-source local). It overrides the
# shared gpt_oss_eval copy. Keep the {{problem}}/{{trace}}/{{hints}} markers.
# =============================================================================
