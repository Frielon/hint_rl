# =============================================================================
# openai-models LOCAL editable copy of the MULTI-ROUND prompt.
# Editing THIS file changes the prompt used by run_openai_multi_selection.py /
# run_openai_multi_eval.sh. It overrides the shared gpt_oss_eval copy, so once
# you edit here the closed-model runs diverge from the gpt-oss reference (that's
# the point). Keep the {{problem}}/{{trace}}/{{hints}} markers and the four
# output fields so the parser/scorer keep working.
# =============================================================================
